...
const defaultProfileImageUrl = 'https://imgnews.pstatic.net/image/445/2024/04/28/0000190204_001_20240428190401536.jpg?type=w647';
...
export default function CSWrite() {
    ...
    const onChargerSelfButtonHandler = () => {
                ...
                <div className='input-container'>
                    ...
                    <div className='input-box'>
                        ...
                        <div className='button-box'>
                            <div className='button second' onClick={onChargerSelfButtonHandler}>자신</div>
